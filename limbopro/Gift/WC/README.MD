...
[仓库](https://github.com/limbopro/Script) 新增加 unblockremote.js，以简化 Quantumult 1.0.3 配置`设备ID`流程，最终使得 [rewrite_remote] 远程引用脚本配置文件可用：(https://raw.githubusercontent.com/NobyDa/Script/master/QuantumultX/Js.conf) ；
