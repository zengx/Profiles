...
如实在想折腾：参考 [Working Copy丨将Github仓库内容同步到手机文件（iOS）并配置 Quantumult X 本地脚本（解锁VSCO/Termius等）](https://limbopro.xyz/archives/workingcopy.html#22.11.2019QX-1.0.3) 前半部分；
